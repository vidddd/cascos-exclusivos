...
(function (window, document) {
	...
	Croppic.prototype = {
		...
		createImgUploadControls: function(){
			...
			var cropControlRemoveCroppedImage = '<span class="cropControlRemoveCroppedImage boton4 rojo">Eliminar Foto</span> ';
		...
		createCropControls: function(){
			...
			html =  '<div class="cropControls cropControlsCrop">'+ cropControlZoomMuchIn + cropControlZoomIn + cropControlZoomOut + cropControlZoomMuchOut + cropControlRotateLeft + cropControlRotateRight + cropControlReset + cropControlCrop  + '</div>';
